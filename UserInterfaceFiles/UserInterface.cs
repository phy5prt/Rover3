...
//allow rovers full name like gregg but require first key press is unique and then only counnt from after length
    class UserInterface
    {
        ...
        String partUserCommandsInput = "single characters to activate user commands. Press Q to quit, ";
        String partRoverCommandsExample = "Input return with no characters to get a full report on all rovers.To give rovers commands input the rover you wish to command followed by the command letters you wish it to execute.For example to move rover T forward, rover Y backward and Face rover U east type TFYBUE.If rover T is the currently selected rover you can type FYBUE.";
        private string Instructions
        {
            get
            {
                ...
                instructions.AppendFormat("{0}{1}{3}", 
                        partUserCommandsInput,
                            "-This will be generated by the usercommands dictionary--",
                            partRoverCommandsExample);
                instructions.AppendLine();
                instructions.AppendFormat("Rovers : {0}", string.Join(" ", StaticMoveCommandFactoryDic.commandKeys.Keys.ToArray()));
                instructions.AppendFormat("Commands: {0}" + string.Join(" ", RoverManagerStatic.RoverDictionary.Keys.ToArray()));
                instructions.AppendLine();
