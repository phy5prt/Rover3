    ...
    class UserInterface
    {
        ...
        private string RoverCommandsInstructions
        {
            get
            {
                ...
                roverCommandsInstructionSB.AppendLine("Rover Commands :");
                    
                    foreach (KeyValuePair<string, MoveCommand> dicEntry in StaticMoveCommandFactoryDic.commandKeys)
                    {
                    roverCommandsInstructionSB.AppendFormat("        {0} : {1}", dicEntry.Key, dicEntry.Value.KeyFunctionDescription);
                    roverCommandsInstructionSB.AppendLine();
                    }
