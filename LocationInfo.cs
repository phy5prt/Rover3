...
namespace Rover3
{
    public class LocationInfo : ICloneable
    {
        ...
        public object Clone()
        {
          return  new LocationInfo((Orientation)this.myOrientation.Clone(), this.XCoord, this.YCoord, this.xLowBound, this.xHighBound, this.yLowBound, this.yHighBound, this.locationFor) as LocationInfo;
